                    ...
                    if (searchBar.text.toString().isNotBlank()) {
                        runOnUiThread {
                            GlobalScope.launch {
                                ...
                                runOnUiThread {
                                    textViewCity.text =
                                        result.body()?.features?.get(0)?.properties?.label ?: ""
                                    val latitude: Double =
                                        result.body()?.features?.get(0)?.geometry?.coordinates?.get(
                                            1
                                        )
                                            ?: 44.8378
                                        ...
                                        runOnUiThread {
                                            if (linearLayout != null) {
                                                when (codes?.get(hour)?.toInt()) {
                                                    ...
                                                    85, 86, 71, 73, 75, 77 -> linearLayout.setBackgroundResource(
                                                        R.drawable.snow
                                                    )
                                                    80, 81, 82 -> linearLayout.setBackgroundResource(
                                                        R.drawable.pluie
                                                    )
                                                    45, 48 -> linearLayout.setBackgroundResource(R.drawable.fog)
                                                    95, 96, 99 -> linearLayout.setBackgroundResource(
                                                        R.drawable.eclair
                                                    )
                                                    51, 53, 55, 56, 57, 61, 63, 65, 66, 67 -> linearLayout.setBackgroundResource(
                                                        R.drawable.petitepluie
                                                    )
                                                    else -> {
